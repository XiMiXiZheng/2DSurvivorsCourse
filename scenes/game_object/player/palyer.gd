...
@onready var hit_random_stream_player: RandomAudioStreamPlayer2DComponent = $HitRandomStreamPlayer as RandomAudioStreamPlayer2DComponent
...
func on_arena_difficulty_increased(arena_difficulty: int):
	...
	if health_regeneration_quantity > 0:
		var is_thirty_seconds_interval = (arena_difficulty % 6) == 0
