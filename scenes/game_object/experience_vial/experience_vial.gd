...
@onready var random_audio_stream_player_2d_component: RandomAudioStreamPlayer2DComponent = $RandomAudioStreamPlayer2DComponent as RandomAudioStreamPlayer2DComponent
